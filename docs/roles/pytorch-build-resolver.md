...
Codex-native port of ECC's `pytorch-build-resolver`.
...
- pytorch build resolver work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/pytorch-build-resolver.md`
