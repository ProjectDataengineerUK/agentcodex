...
Codex-native port of ECC's `cpp-build-resolver`.
...
- c++ build resolver work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/cpp-build-resolver.md`
