...
Codex-native port of AgentSpec's `spark-troubleshooter`.
...
- root-cause analysis and remediation paths
- clear escalation when the task exceeds role scope

## Use For

- spark troubleshooter work needs a dedicated specialist pass
...
- `.agentcodex/imports/agentspec/agents/data-engineering/spark-troubleshooter.md`
