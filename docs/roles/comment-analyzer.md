...
Codex-native port of ECC's `comment-analyzer`.

Analyze code comments for accuracy, completeness, maintainability, and comment rot risk.

## Focus

- comment analyzer task execution
- comment analyzer review boundaries
- clear escalation when the task exceeds role scope

## Use For

- comment analyzer work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/comment-analyzer.md`
