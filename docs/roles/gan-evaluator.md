...
Codex-native port of ECC's `gan-evaluator`.

GAN Harness — Evaluator agent. Tests the live running application via Playwright, scores against rubric, and provides actionable feedback to the Generator.

## Focus

- GAN workflow planning, generation, or evaluation
- KB-first evidence gathering before recommendations
- clear escalation when the task exceeds role scope

## Use For

- gan evaluator work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/gan-evaluator.md`
