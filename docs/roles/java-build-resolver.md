...
Codex-native port of ECC's `java-build-resolver`.
...
- java build resolver work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/java-build-resolver.md`
