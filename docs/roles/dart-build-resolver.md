...
Codex-native port of ECC's `dart-build-resolver`.
...
- dart build resolver work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/dart-build-resolver.md`
