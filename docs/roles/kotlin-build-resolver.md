...
Codex-native port of ECC's `kotlin-build-resolver`.
...
- kotlin build resolver work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/kotlin-build-resolver.md`
