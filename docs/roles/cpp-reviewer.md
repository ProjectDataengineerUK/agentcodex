...
Codex-native port of ECC's `cpp-reviewer`.

Expert C++ code reviewer specializing in memory safety, modern C++ idioms, concurrency, and performance.
...
- `.agentcodex/imports/ecc/agents/cpp-reviewer.md`
