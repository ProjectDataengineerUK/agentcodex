...
Codex-native port of AgentSpec's `fabric-ai-specialist`.
...
- fabric ai specialist work needs a dedicated specialist pass
...
- `.agentcodex/imports/agentspec/agents/platform/fabric-ai-specialist.md`
