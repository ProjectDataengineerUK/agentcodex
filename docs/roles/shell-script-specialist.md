...
Codex-native port of AgentSpec's `shell-script-specialist`.
...
- shell script specialist task execution
- shell script specialist review boundaries
- clear escalation when the task exceeds role scope

## Use For

- shell script specialist work needs a dedicated specialist pass
...
- `.agentcodex/imports/agentspec/agents/dev/shell-script-specialist.md`
