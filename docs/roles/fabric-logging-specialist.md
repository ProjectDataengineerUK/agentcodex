...
Codex-native port of AgentSpec's `fabric-logging-specialist`.
...
- fabric logging specialist work needs a dedicated specialist pass
...
- `.agentcodex/imports/agentspec/agents/platform/fabric-logging-specialist.md`
