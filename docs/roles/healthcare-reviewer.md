...
Codex-native port of ECC's `healthcare-reviewer`.
...
- healthcare reviewer work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/healthcare-reviewer.md`
