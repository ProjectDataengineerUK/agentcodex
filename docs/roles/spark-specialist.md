...
Codex-native port of AgentSpec's `spark-specialist`.
...
- spark specialist work needs a dedicated specialist pass
...
- `.agentcodex/imports/agentspec/agents/data-engineering/spark-specialist.md`
