...
Codex-native port of ECC's `go-reviewer`.

Expert Go code reviewer specializing in idiomatic Go, concurrency patterns, error handling, and performance.
...
- go reviewer work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/go-reviewer.md`
