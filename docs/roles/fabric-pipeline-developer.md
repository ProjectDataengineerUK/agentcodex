...
Codex-native port of AgentSpec's `fabric-pipeline-developer`.
...
- fabric pipeline developer work needs a dedicated specialist pass
...
- `.agentcodex/imports/agentspec/agents/platform/fabric-pipeline-developer.md`
