...
Codex-native port of ECC's `opensource-forker`.
...
- opensource forker work needs a dedicated specialist pass
...
- `.agentcodex/imports/ecc/agents/opensource-forker.md`
